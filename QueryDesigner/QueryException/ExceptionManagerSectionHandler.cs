	...
	public class ExceptionManagerSectionHandler : IConfigurationSectionHandler
	{
		...
		public object Create(object parent,object configContext,XmlNode section)
		{
			...
			catch(Exception exc)
			{
                ...
                throw new System.Configuration.ConfigurationErrorsException(ExceptionConst.RES_EXCEPTION_LOADING_CONFIGURATION, exc, section);
			}
		}
				...
				for (int i=0;i<rawFilter.GetLength(0);i++)
				{
					...
					else
					{
						...
						catch(TypeLoadException e)
						{
                            ...
                            ExceptionManager.PublishInternalException(new System.Configuration.ConfigurationErrorsException(ExceptionConst.RES_EXCEPTION_LOADING_CONFIGURATION, e), null);
						}													
					}
				}
			}
